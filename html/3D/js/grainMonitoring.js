...
layui.use(['form', 'laydate', 'layer'], function () {
    ...
    Main.prototype = {
        ...
        */
        searchData: function () {
            var that = this;
            var searchFormData = aoUtils.getFormData('#searchForm');
            var obj = {
                tab: this.curTab,
                dateTime: searchFormData.dateTime
            };
       ...
       */
        ...
        */
        renderBar: function (data) {
            ...
            var colors = ['#449FFF', '#A54EF8', '#FDD047'];
     ...
     */
        ...
        'renderTable': function (data) {
            ...
            var tmpl = '<tr>' +
                ...
                '<td title="{{gjlx}}" width="80px" class="lsvs_tc is-hightlight">{{gjlx}}</td>' +
        ...
        */
        bindEvents: function () {
            ...
            $("#btnDownload").hover(function () {
                subtips = layer.tips('导出告警详情', '#btnDownload', { tips: [1,'#BDECF6'], time: 0 })
            }, function () {
                layer.close(subtips);
            })
            ...
            $("#btnTips2").hover(function () {
                ...
                subtips2 = layer.tips(html, '#btnTips2', { tips: [1, '#BDECF6'], time: 0, area: ['200', 'auto'] })
            }, function () {
